const images = [
        ...
        const images1 = [
            'https://www.youtube.com/watch?v=FPJ2T26ydlk',
            'https://www.youtube.com/watch?v=JmSC9xahhyA',
            'https://www.youtube.com/watch?v=4xxbhYRvW5Y',
            'https://www.youtube.com/watch?v=kXj0o0gIbho',
            'https://www.youtube.com/watch?v=LRvzUgyJucA'
        ];
// 隨機選擇一張圖片
const randomIndex = Math.floor(Math.random() * images.length);
document.getElementById('video-background').src = images[randomIndex];
document.getElementById('video-Link').href = images1[randomIndex];